	    ...
	    <div class="am-offcanvas-bar admin-offcanvas-bar p-b-30" style="width: 251px; border-right: 1px solid gainsboro;">	
	    	<div class="user-box am-hide-sm-only">
			 ...
			 <ul class="am-list admin-sidebar-list" >
			    ...
			    <li>
			      <a class="am-cf" data-am-collapse="{target: '#collapse-nav1'}"><span class="am-icon-group" />&nbsp;&nbsp;会员管理 <span class="am-icon-angle-right am-fr am-margin-right" /></span></a>
			    ...
			    <li>
			      ...
			      <a class="am-cf" data-am-collapse="{target: '#collapse-nav4'}"><span class="am-icon-table" />&nbsp;&nbsp;预约管理 <span class="am-icon-angle-right am-fr am-margin-right" /></a>
